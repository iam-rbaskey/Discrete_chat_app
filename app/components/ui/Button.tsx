...
export const Button: React.FC<ButtonProps> = ({
    ...
    const variants = {
        primary: 'bg-white text-black hover:bg-zinc-200 border border-transparent shadow-[0_0_15px_rgba(255,255,255,0.2)]',
        secondary: 'bg-zinc-800 text-white hover:bg-zinc-700 border border-zinc-700',
        ghost: 'hover:bg-white/10 text-zinc-400 hover:text-white',
        glass: 'glass-premium text-white hover:bg-white/10',
    };
