    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[--color-background] p-4 relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-[20%] left-[20%] w-[40%] h-[40%] bg-[--color-accent]/10 blur-[120px] rounded-full animate-pulse-slow"></div>
                <div className="absolute bottom-[20%] right-[20%] w-[40%] h-[40%] bg-[--color-secondary]/10 blur-[120px] rounded-full animate-pulse-slow" style={{ animationDelay: '2s' }}></div>
            ...
            <div className="max-w-sm w-full glass-premium p-8 rounded-2xl border border-white/5 relative z-10 backdrop-blur-2xl shadow-2xl">
                <div className="text-center mb-8">
                    <div className="w-16 h-16 bg-[--color-accent]/10 rounded-2xl border border-[--color-accent]/30 mx-auto flex items-center justify-center mb-4 shadow-[0_0_20px_rgba(6,182,212,0.2)]">
                        <Wifi className="w-8 h-8 text-[--color-accent] animate-pulse" />
                    </div>
                    <h1 className="text-2xl font-bold text-white tracking-widest uppercase">
                        Terminal Access
                    </h1>
                    <p className="text-slate-500 text-xs mt-1 font-mono">Secure Connection Required</p>
                </div>
